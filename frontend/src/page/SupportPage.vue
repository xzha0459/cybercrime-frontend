...
/* warning box heading and content */
.warning-box h3 {
  color: #c53030;
  font-size: 1.25rem;
  font-weight: 600;
...
.resource-item {
  ...
  box-shadow: 0 1px 0 rgba(0,0,0,0.02), 0 8px 16px rgba(0,0,0,0.04);
...
.resource-item:hover {
  ...
  border-color: #38b2ac;
  box-shadow: 0 2px 0 rgba(0,0,0,0.03), 0 14px 24px rgba(0,0,0,0.06);
}

/* Resources section heading and item label */
.resources h2 {
  font-size: 2rem;
  font-weight: 600;
  text-align: center;
